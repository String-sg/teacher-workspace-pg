...
/** Pick a single student name to stand in for the per-parent child-name line.
 *  Only individual-student selections carry a real name; groups/classes show
 *  the "STUDENT NAME" placeholder so the preview stays realistic. */
function summariseRecipients(recipients: PostFormState['selectedRecipients']): string | null {
  ...
  return individual ? individual.label.toUpperCase() : null;
}
